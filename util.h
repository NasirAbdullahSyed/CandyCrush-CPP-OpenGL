...
{ 
	{ 0.501960784313726, 0, 0 }, { 0.545098039215686,
...
#define ABS(A) ((A) < (0) ? -(A):(A))  // find ABS of a given number
		...
		void DrawLine(float x1, float y1, float x2, float y2, int lwidth=3, float *color =NULL);
		// Function draws a rectangle with rounded corners at given x,y coordinates
		void DrawCandy(float x, float y, float width, float height,	float* color = 0, float radius = 0.0);
