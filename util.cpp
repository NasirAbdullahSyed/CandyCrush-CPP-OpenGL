...
void DrawLine(float x1, float y1, float x2, float y2, int lwidth, float *color) 
{
	glLineWidth(lwidth);
	if(color)
	{
...
void DrawCandy(float x, float y, float width, float height, float* color,float radius) 
	{
	y = y + height;
